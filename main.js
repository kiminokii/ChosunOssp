...
var started = false;
var url = "file:///Users/okii/Desktop/programming/HTML/OSSP/maze/index.html"
...
function Player(x, y) {
    ...
    this.draw = function () {
        ...
        gradient.addColorStop(indice1, "#9C0648");
        gradient.addColorStop(indice2, "#5D0185");
        gradient.addColorStop(indice2, "#370C9C");
...
function Goal(x, y) {
    ...
    this.y = y * widthofCell + space;
    this.img = new Image();
    this.img.src = '/Users/okii/Desktop/programming/HTML/OSSP/maze/images/goal.png';
    this.draw = () => {
